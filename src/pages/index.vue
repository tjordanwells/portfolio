<template>
  <v-container class="hel-neue fill-height h-75">
    ...
    <v-row class="mt-8 text-center hel-neue-light">
      <v-col cols="12">
        <a href="https://linkedin.com/in/tjordanwells" target="_blank">linkedin</a>
      </v-col>
      <v-col cols="12">
        <a href="https://github.com/tjordanwells" target="_blank">github</a>
      </v-col>
      <v-col cols="12">
        <a href="https://issuu.com/tjordanwells/docs/sp24_arc_portfolio_jordan_wells" target="_blank">issuu</a>
      </v-col>
    </v-row>
  </v-container>
</template>
